...
type UbaToolAdCreateCreateV10ApiService service
...
func (r *ApiOpenApiV10UbaToolAdCreateCreatePostRequest) AccessToken(accessToken string) *ApiOpenApiV10UbaToolAdCreateCreatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10UbaToolAdCreateCreatePostRequest) WithLog(enable bool) *ApiOpenApiV10UbaToolAdCreateCreatePostRequest {
	if enable {
...
/*
OpenApiV10UbaToolAdCreateCreatePost Method for OpenApiV10UbaToolAdCreateCreatePost

创建计划

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV10UbaToolAdCreateCreatePostRequest
*/
func (a *UbaToolAdCreateCreateV10ApiService) Post(ctx context.Context) *ApiOpenApiV10UbaToolAdCreateCreatePostRequest {
	return &ApiOpenApiV10UbaToolAdCreateCreatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *UbaToolAdCreateCreateV10ApiService) postExecute(r *ApiOpenApiV10UbaToolAdCreateCreatePostRequest) (*UbaToolAdCreateCreateV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.ubaToolAdCreateCreateV10Request
