...
type CgTransferV2WalletCanTransferBalanceBetweenAccountGetV30ApiService service

type ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest struct {
	ctx                     context.Context
...
// 鉴权账户
func (r *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest) AccountId(accountId int64) *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest {
...
func (r *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest) AccessToken(accessToken string) *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest) WithLog(enable bool) *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest {
	if enable {
...
/*
OpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGet Method for OpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGet

查询转出方与转入方之间最大可转金额，支持查询M:N。只支持钱包<->钱包场景

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest
*/
func (a *CgTransferV2WalletCanTransferBalanceBetweenAccountGetV30ApiService) Get(ctx context.Context) *ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest {
	return &ApiOpenApiV30CgTransferV2WalletCanTransferBalanceBetweenAccountGetGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
