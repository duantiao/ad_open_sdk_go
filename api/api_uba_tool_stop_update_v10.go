...
type UbaToolStopUpdateV10ApiService service
...
func (r *ApiOpenApiV10UbaToolStopUpdatePostRequest) AccessToken(accessToken string) *ApiOpenApiV10UbaToolStopUpdatePostRequest {
	r.ctx = context.WithValue(r.ctx, config.ContextAccessToken, accessToken)
	return r
}

func (r *ApiOpenApiV10UbaToolStopUpdatePostRequest) WithLog(enable bool) *ApiOpenApiV10UbaToolStopUpdatePostRequest {
	if enable {
...
/*
OpenApiV10UbaToolStopUpdatePost Method for OpenApiV10UbaToolStopUpdatePost

项目计划关停

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiOpenApiV10UbaToolStopUpdatePostRequest
*/
func (a *UbaToolStopUpdateV10ApiService) Post(ctx context.Context) *ApiOpenApiV10UbaToolStopUpdatePostRequest {
	return &ApiOpenApiV10UbaToolStopUpdatePostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *UbaToolStopUpdateV10ApiService) postExecute(r *ApiOpenApiV10UbaToolStopUpdatePostRequest) (*UbaToolStopUpdateV10Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.ubaToolStopUpdateV10Request
