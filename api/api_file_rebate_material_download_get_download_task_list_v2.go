...
func (r *ApiOpenApi2FileRebateMaterialDownloadGetDownloadTaskListGetRequest) Execute() (*models.FileRebateMaterialDownloadGetDownloadTaskListV2Response, *http.Response, error) {
...
func (a *FileRebateMaterialDownloadGetDownloadTaskListV2ApiService) getExecute(r *ApiOpenApi2FileRebateMaterialDownloadGetDownloadTaskListGetRequest) (*models.FileRebateMaterialDownloadGetDownloadTaskListV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           map[string]*models.FormFileInfo
		localVarReturnValue *models.FileRebateMaterialDownloadGetDownloadTaskListV2Response
	)
