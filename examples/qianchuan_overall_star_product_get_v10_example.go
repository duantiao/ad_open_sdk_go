...
// url: https://api.oceanengine.com/open_api/v1.0/qianchuan/overall_star_product/get/ Get
func main() {
	const demoreq = ``
	...
	var request ApiOpenApiV10QianchuanOverallStarProductGetGetRequestExample
